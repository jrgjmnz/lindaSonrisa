...
<head>
  ...
  <title>Boleta Generando Recepcionista</title>
...
<body>
  ...
  <div class="navbar-fixed" >
    <nav class="nav-wrapper" style="background-color:rgb(101, 101, 100 ,0.3);">
      ...
      <div class="">
        ...
        <img src="img/iconoclinica.png" alt="icono" style=" margin-top: 10px; width:42px;height:42px;border:2;">
  ...
  <form action="BoletaGenerandoA.html" style="margin-top:20px; margin-left: 35px;">
    <a href="BoletaGenerandoA.html" id="generar" class="waves-effect waves-light btn-small">Imprimir</a>
  </form>
