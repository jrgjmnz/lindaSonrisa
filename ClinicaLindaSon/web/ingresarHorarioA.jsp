...
<head>
    ...
    <title>Ingresar Horario Administrador</title>
...
<body>
    ...
    <form action="">
            <fieldset>
              <h2 class="black-text">Ingrese Horario Disponible:</h2><br>
            </fieldset>
          </form>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                                <select>
                                        <option value="" disabled selected>Selecciona</option>
                                        <option value="1">Sandra Veas</option>
                                        <option value="2">Carmen Albornoz</option>
                                      </select>
                                      <label>Doctor:</label>
                        </div>
                    ...
                    <div class="form-field">
                        <button class="btn modal-trigger teal darken-3" data-target="idModal">Ingresar</button>
