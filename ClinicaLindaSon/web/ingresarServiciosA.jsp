...
<head>
    ...
    <title>Ingresar Servicios Administrador</title>
    ...
    <div class="col s4 offset-s4">
        <div class="card">
            <div class="card-action white-text" >
                <h3>Ingrese Servicio Nuevo</h3>
            </div>
            <div class="card-content">
                <div class="form-field">
                    <input type="text" placeholder="Nombre Servicio" id="nombreServicio" class="validate" required>

                </div><br>
                <div class="form-field">
                    <input type="text" placeholder="Valor" id="valor" class="validate" required>
