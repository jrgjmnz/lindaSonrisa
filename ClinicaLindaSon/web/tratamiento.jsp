...
<head>
    ...
    <style>
        ...
        body {
            background-image: url(img/Tratamientoa.jpg);
...
<body>
  ...
  <li><a href="inicioSesionE.jsp">Empleado</a></li>
    ...
    <p class="center">
        <img src="img/RayosX.png">
        <img src="img/Periodoncia.png">
        <img src="img/Escaner.png">

    </p>
    <p class="center">
        <img src="img/CirugiaMenor.png">
        <img src="img/Odontopediatria.png">
        <img src="img/Implanteologia.png">
    </p>
    <p class="center">
        <img src="img/BlanqueamientoDental.png">
    </p>
