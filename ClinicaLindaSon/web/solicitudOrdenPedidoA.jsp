...
<head>
  ...
  <title>Solicitud Orden Pedido Administrador</title>
...
<body>
  ...
  <form action="">
    <fieldset>
      <h2 class="black-text">Solicitud Orden de Pedido</h2><br>
    </fieldset>
  </form>
  ...
  <form action="" style="margin-top:20px; margin-left: 35px;">
    <a class="waves-effect waves-light btn-small">Mostrar</a>
    <a class="waves-effect waves-light btn-small">Confirmar</a>
  </form>
